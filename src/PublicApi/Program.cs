...
public class Program
{
    ...
    private static async Task Main(string[] args)
    {
        ...
        AddAzureServices(builder.Services, builder.Host);

        DatabaseDependencies.ConfigureDatabasesServices(builder.Configuration, builder.Services);

        AddIdentitiesAndDatabaseServices(builder.Services, builder.Configuration);
    ...
    private static void AddAzureServices(IServiceCollection services, IHostBuilder hostBuilder)
    {
        AzureDependencies.AddGenericAzureServices(services, hostBuilder);
    }

    private static void AddIdentitiesAndDatabaseServices(IServiceCollection services, IConfiguration configuration)
    {
